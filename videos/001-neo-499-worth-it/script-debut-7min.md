# VIDEO #001 (DEBUT CUT) — The $499/Month Home Robot: What They Don't Tell You

**Status:** PRODUCTION — 7-minute debut cut, condensed from `script-final.md` (HUMAN_PASS-approved material only; Brian's paragraphs preserved trimmed). Skim at watch-through.
**Target:** ~7 min (≈1,150 words). The 20-min master remains the extended edition.
**Voice:** en-US-BrianMultilingualNeural ("The Insider") — rate +4%, pitch -4Hz (LOCKED 2026-07-10).
...
**[B-ROLL: S1 evidence frame → 00-title card]**
...
### THE MACHINE AND THE WAITLIST (0:45)

**[B-ROLL: S2 order page, S3 product shot → spec card builds]**
...
### THE PERSON INSIDE (2:30)

**[B-ROLL: S4 heads evidence frame → Expert Mode privacy builds]**
...
### THE HONEST MATH (4:15)

**[GRAPHIC: subscription math builds → three options builds → cost curve builds]**
...
**[GRAPHIC: verdict tree builds → buy signal]**
...
> A humanoid robot for $499/month sounds like the future — and I'm on team robot. But nobody who ordered one has it yet, a remote operator can see through its eyes, and the math says most people should wait. Here's what $499/month actually buys, and the exact buy signal to wait for.
>
> ⏱ CHAPTERS (set after final render)
> 0:00 The $499 pitch
> 0:45 The machine and the waitlist
> 2:30 The person inside the robot
> 4:15 The honest math
> 6:00 Verdict: buy, subscribe, or wait
>
> 🔗 Robot vacuum I actually recommend: [AFFILIATE LINK]
>
> Parts of this video use AI-generated narration and visuals, disclosed per YouTube policy. All analysis and opinions are my own. Sources: 1x.tech, WSJ, Fortune, Goldman Sachs, BofA Institute, CareScout, shop.unitree.com, chinaselectcommittee.house.gov — all verified 2026-07-09.
>
> #homerobot #1xneo #humanoidrobot
